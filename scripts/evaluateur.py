"""
Evaluateur d'affectation manuelle (Phase 2, S7 J4).
...
Decisions de cadrage (S7 J4) :
  ...
  - BINOME D12 non controle : un chauffeur different de l'attitre est accepte
    sans signalement (arbitrage S7 J4).
...
def evaluer(db, id_vague: str,
    ...
    Etapes :
      1. charge la matrice routiere (plancher D13) une seule fois ;
      2. pour chaque tournee imposee : controles + reordonnancement TSP ;
      3. couverture de vague : lots de la vague non affectes.
    """
    # matrice routiere brute -> plancher D13 (dormant depuis D14). On ignore
